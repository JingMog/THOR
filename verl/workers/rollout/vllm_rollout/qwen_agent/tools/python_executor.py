...
from verl.workers.rollout.vllm_rollout.qwen_agent.tools.base import BaseTool
from verl.workers.rollout.vllm_rollout.qwen_agent.utils.utils import extract_code
...
class PythonExecutor(BaseTool):
    ...
    def batch_apply(self, batch_code: List[str]) -> list:
        ...
        timeout_cnt = 0
        all_exec_results = []
        max_workers = min(len(all_code_snippets), 8)
        with ProcessPool(max_workers=max_workers) as pool:
            ...
            if len(all_code_snippets) > 100000:
